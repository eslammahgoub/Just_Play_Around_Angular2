...
@Component({
  ...
  template: `
    ...
    <md-input-container style="width:100%;">
        ...
        readonly="true"
      >
      <span mdSuffix (click)="onInputClick()">
        <i md-icon class="material-icons">date_range</i>
      </span>
    </md-input-container>
      <div
...
export class DatepickerComponent implements OnInit, OnChanges {
  ...
  @Output() onDateChange = new EventEmitter<Array<Date> | Date>();
  // time
